#ifndef FAST_GrowCutSegmenter_H
#define FAST_GrowCutSegmenter_H
...
/***************************************************************************
* class FastGrowCutHeapNode
***************************************************************************/
class FastGrowCutHeapNode : public FibHeapNode {
    float   N;
    long IndexV;

public:
    FastGrowCutHeapNode() : FibHeapNode() { N = 0; }
