/*=========================================================================
  ...
  Module:    vtkVusionContourWidget.h
...
=========================================================================*/
/**
 * @class   vtkVusionContourWidget
 * @brief   create a contour with a set of points
 *
 * The vtkVusionContourWidget is used to select a set of points, and draw lines
 ...
 * events (that are triggered by VTK events). The vtkVusionContourRepresentation is
 ...
 * into the vtkVusionContourWidget's widget events:
 * <pre>
...
#ifndef vtkVusionContourWidget_h
#define vtkVusionContourWidget_h
...
class VTKINTERACTIONWIDGETS_EXPORT vtkVusionContourWidget : public vtkAbstractWidget
{
public:
  /**
   * Instantiate this class.
   */
  static vtkVusionContourWidget *New();

  //@{
  /**
   * Standard methods for a VTK class.
   */
  vtkTypeMacro(vtkVusionContourWidget,vtkAbstractWidget);
   ...
   */
  void SetRepresentation(vtkVusionContourRepresentation *r)
    {this->Superclass::SetWidgetRepresentation(reinterpret_cast<vtkWidgetRepresentation*>(r));}

  /**
   * Return the representation as a vtkVusionContourRepresentation.
   */
  vtkVusionContourRepresentation *GetContourRepresentation()
    {return reinterpret_cast<vtkVusionContourRepresentation*>(this->WidgetRep);}
...
private:
  vtkVusionContourWidget(const vtkVusionContourWidget&) ;
  void operator=(const vtkVusionContourWidget&) ;
};
