/*=========================================================================
  ...
  Module:    vtkVusionImageMapToWindowLevelColors.cxx
...
vtkStandardNewMacro(vtkVusionImageMapToWindowLevelColors);

// Constructor sets default values
vtkVusionImageMapToWindowLevelColors::vtkVusionImageMapToWindowLevelColors()
{
  this->Window = 255;
  this->Level  = 127.5;
}
...
int vtkVusionImageMapToWindowLevelColors::RequestData(
...
//----------------------------------------------------------------------------
int vtkVusionImageMapToWindowLevelColors::RequestInformation (
...
template <class T>
void vtkVusionImageMapToWindowLevelColorsExecute(
  vtkVusionImageMapToWindowLevelColors *self,
...
void vtkVusionImageMapToWindowLevelColors::ThreadedRequestData(
  vtkInformation *vtkNotUsed(request),
  ...
  int outExt[6], int id)
{
  ...
  {
    vtkTemplateMacro(
      vtkVusionImageMapToWindowLevelColorsExecute(this,
                                            inData[0][0],
...
void vtkVusionImageMapToWindowLevelColors::PrintSelf(ostream& os, vtkIndent indent)
{
