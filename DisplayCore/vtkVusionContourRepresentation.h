/*=========================================================================
  ...
  Module:    vtkVusionContourRepresentation.h
 ...
 * @brief   represent the vtkVusionContourWidget
 *
 * The vtkVusionContourRepresentation is a superclass for various types of
 * representations for vtkVusionContourWidget.
 *
 * @par Managing contour points:
 * The classes vtkVusionContourRepresentationNode, vtkVusionContourRepresentationInternals,
 * and vtkVusionContourRepresentationPoint manage the data structure used to represent
 ...
 *
 * @sa
 * vtkVusionContourWidget
*/

#ifndef vtkVusionContourRepresentation_h
#define vtkVusionContourRepresentation_h
...
//----------------------------------------------------------------------
class vtkVusionContourRepresentationPoint
{
public:
...
class vtkVusionContourRepresentationNode
{
public:
  double        WorldPosition[3];
  ...
  double        NormalizedDisplayPosition[2];
  int           Selected;
  std::vector<vtkVusionContourRepresentationPoint*> Points;
...
class vtkVusionContourRepresentationInternals
{
public:
  std::vector<vtkVusionContourRepresentationNode*> Nodes;
  void ClearNodes()
  {
...
class VTKINTERACTIONWIDGETS_EXPORT vtkVusionContourRepresentation : public vtkWidgetRepresentation
{
  friend class vtkVusionContourWidget;
public:
  //@{
  /**
   * Standard VTK methods.
   */
  vtkTypeMacro(vtkVusionContourRepresentation,vtkWidgetRepresentation);
   ...
   * Get the nth node.
   */
  virtual vtkVusionContourRepresentationNode *GetNthNode(int n);
  ...
  vtkSetClampMacro( CurrentOperation, int,
                    vtkVusionContourRepresentation::Inactive,
                    vtkVusionContourRepresentation::Scale );
  void SetCurrentOperationToInactive()
    { this->SetCurrentOperation( vtkVusionContourRepresentation::Inactive ); }
  void SetCurrentOperationToTranslate()
    { this->SetCurrentOperation( vtkVusionContourRepresentation::Translate ); }
  void SetCurrentOperationToShift()
    {this->SetCurrentOperation( vtkVusionContourRepresentation::Shift ); }
  void SetCurrentOperationToScale()
    {this->SetCurrentOperation( vtkVusionContourRepresentation::Scale ); }
  //@}
   ...
   * nodes.
   */
  void SetLineInterpolator( vtkVusionContourLineInterpolator *);
  vtkGetObjectMacro( LineInterpolator, vtkVusionContourLineInterpolator );
  //@}
...
protected:
  ...
  vtkVusionContourLineInterpolator *LineInterpolator;
  ...
  vtkVusionContourRepresentationInternals *Internal;
   ...
   * vtkVusionContourWidget::Initialize. The idlist here may be used to initialize
...
private:
  vtkVusionContourRepresentation(const vtkVusionContourRepresentation&) ;
  void operator=(const vtkVusionContourRepresentation&);
};
